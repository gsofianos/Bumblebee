...
public class Bumblebee.Core.Player : GLib.Object {
    ...
    public void add (Models.Station station) throws Bumblebee.Error {
        ...
        if ( content_type == "audio/x-mpegurl" || content_type == "audio/mpegurl" ) {
            ...
            if ( list != null )
                ...
                throw new Bumblebee.Error.Player ("Could not decode m3u file, wrong url or corrupted file");
        }
            ...
            if ( list != null )
                ...
                throw new Bumblebee.Error.Player ("Could not decode pls file, wrong url or corrupted file");
            ...
            if ( list != null )
                ...
                throw new Bumblebee.Error.Player ("Could not decode asx file, wrong url or corrupted file");
        }
